...
const Hero: React.FC<IHeroProps> = (props) => {
  ...
  return (
    <section className="lg:h-[1024px] h-[767px]  md:max-h-[994px] md:h-screen overflow-hidden relative text-white">
      <div className="h-[770px] md:h-[1006px] lg:h-[998px] rounded-b-full -z-10 bg-primary-900 absolute mx-auto w-full scale-x-[1.4] top-0 inset-x-0" />
