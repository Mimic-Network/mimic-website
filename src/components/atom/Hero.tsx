...
const Hero: React.FC<IHeroProps> = (props) => {
  ...
  return (
    <section className="md:h-[100vh] h-[90vh] overflow-hidden relative text-white">
      <div className="md:h-screen h-[90vh] rounded-b-full -z-10 bg-primary-900 absolute mx-auto w-full scale-x-[1.4] top-0 inset-x-0" />
